...
abstract class BaseSetupMstCoys extends GxActiveRecord {
	...
	public function rules() {
		return array(
			...
			array('v_closing', 'length', 'max'=>1),
			array('d_created_date, d_updated_date', 'safe'),
			array('v_company_group, v_regn_no, v_short_name, v_jenis_usaha, v_mobilitas, v_office_hours, n_existing_agent, v_comp_add1, v_comp_add2, v_comp_add3, v_postcode, v_town, v_state_code, v_country_code, v_phone1, v_phone2, v_fax, v_email, v_contact_person, v_closing, v_created_by, d_created_date, v_updated_by, d_updated_date', 'default', 'setOnEmpty' => true, 'value' => null),
			array('v_company_code, v_company_group, v_inst_type, v_company_name, v_regn_no, v_short_name, v_jenis_usaha, v_mobilitas, v_office_hours, n_existing_agent, v_comp_add1, v_comp_add2, v_comp_add3, v_postcode, v_town, v_state_code, v_country_code, v_phone1, v_phone2, v_fax, v_email, v_contact_person, v_closing, v_created_by, d_created_date, v_updated_by, d_updated_date', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels() {
		return array(
			'v_company_code' => Yii::t('app', 'V Company Code'),
			'v_company_group' => Yii::t('app', 'V Company Group'),
			'v_inst_type' => Yii::t('app', 'V Inst Type'),
			'v_company_name' => Yii::t('app', 'V Company Name'),
			'v_regn_no' => Yii::t('app', 'V Regn No'),
			'v_short_name' => Yii::t('app', 'V Short Name'),
			'v_jenis_usaha' => Yii::t('app', 'V Jenis Usaha'),
			'v_mobilitas' => Yii::t('app', 'V Mobilitas'),
			'v_office_hours' => Yii::t('app', 'V Office Hours'),
			'n_existing_agent' => Yii::t('app', 'N Existing Agent'),
			'v_comp_add1' => Yii::t('app', 'V Comp Add1'),
			'v_comp_add2' => Yii::t('app', 'V Comp Add2'),
			'v_comp_add3' => Yii::t('app', 'V Comp Add3'),
			'v_postcode' => Yii::t('app', 'V Postcode'),
			'v_town' => Yii::t('app', 'V Town'),
			'v_state_code' => Yii::t('app', 'V State Code'),
			'v_country_code' => Yii::t('app', 'V Country Code'),
			'v_phone1' => Yii::t('app', 'V Phone1'),
			'v_phone2' => Yii::t('app', 'V Phone2'),
			'v_fax' => Yii::t('app', 'V Fax'),
			'v_email' => Yii::t('app', 'V Email'),
			'v_contact_person' => Yii::t('app', 'V Contact Person'),
			'v_closing' => Yii::t('app', 'V Closing'),
	...
	public function search() {
		...
		$criteria->compare('v_closing', $this->v_closing, true);
