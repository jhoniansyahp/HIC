...
abstract class BasePolDtlPolis extends GxActiveRecord {
	...
	public function rules() {
		return array(
			array('v_policy_no, n_line_no, v_plan_code, v_main_member, v_sex', 'required'),
			...
			array('d_dob, d_start, d_end, d_migrate, d_mutasi, d_verifikasi_date, d_upload_date, d_created_date, d_updated_date', 'safe'),
