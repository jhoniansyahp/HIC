...
abstract class BaseSetupMstPlans extends GxActiveRecord {
	...
	public function attributeLabels() {
		return array(
			...
			'v_plan_name' => Yii::t('app', 'V Plan Name'),
			'v_plan_desc' => Yii::t('app', 'V Plan Desc'),
			'd_plan_start' => Yii::t('app', 'D Plan Start'),
			'd_plan_end' => Yii::t('app', 'D Plan End'),
			'v_prod_line' => Yii::t('app', 'V Prod Line'),
			'v_prod_composition' => Yii::t('app', 'V Prod Composition'),
			'v_indv_or_group' => Yii::t('app', 'V Indv Or Group'),
			'v_plan_type' => Yii::t('app', 'V Plan Type'),
			'v_curr_code' => Yii::t('app', 'V Curr Code'),
			'v_status' => Yii::t('app', 'V Status'),
