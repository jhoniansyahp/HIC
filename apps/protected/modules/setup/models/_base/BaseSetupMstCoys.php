...
abstract class BaseSetupMstCoys extends GxActiveRecord {
	...
	public function attributeLabels() {
		return array(
			'v_company_code' => Yii::t('setupModule.main', 'Company Code'),
			'v_company_group' => Yii::t('setupModule.main', 'Company Group'),
			'v_inst_type' => Yii::t('setupModule.main', 'Inst Type'),
			'v_company_name' => Yii::t('setupModule.main', 'Company Name'),
			'v_regn_no' => Yii::t('setupModule.main', 'Regn No'),
			'v_short_name' => Yii::t('setupModule.main', 'Short Name'),
			'v_jenis_usaha' => Yii::t('setupModule.main', 'Jenis Usaha'),
			'v_mobilitas' => Yii::t('setupModule.main', 'Mobilitas'),
			'v_office_hours' => Yii::t('setupModule.main', 'Office Hours'),
			'n_existing_agent' => Yii::t('setupModule.main','Existing Agent'),
			'v_comp_add1' => Yii::t('setupModule.main', 'Comp Add1'),
			'v_comp_add2' => Yii::t('setupModule.main', 'Comp Add2'),
			'v_comp_add3' => Yii::t('setupModule.main', 'Comp Add3'),
			'v_postcode' => Yii::t('setupModule.main', 'Postcode'),
			'v_town' => Yii::t('setupModule.main', 'Town'),
			'v_state_code' => Yii::t('setupModule.main', 'State Code'),
			'v_country_code' => Yii::t('setupModule.main', 'Country Code'),
			'v_phone1' => Yii::t('setupModule.main', 'Phone1'),
			'v_phone2' => Yii::t('setupModule.main', 'Phone2'),
			'v_fax' => Yii::t('setupModule.main', 'Fax'),
			'v_email' => Yii::t('setupModule.main', 'Email'),
			'v_contact_person' => Yii::t('setupModule.main', 'Contact Person'),
			...
			'nExistingAgent' => Yii::t('setupModule.main','NExistingAgent'),
		);
	}
