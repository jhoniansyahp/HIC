...
abstract class BaseSetupMstOrganizations extends GxActiveRecord {
	...
	public function attributeLabels() {
		return array(
			'n_org_id' => Yii::t('setupModule.main', 'Org'),
			'v_org_code' => Yii::t('setupModule.main', 'Org Code'),
			'v_org_name' => Yii::t('setupModule.main', 'Org Name'),
			'd_start_date' => Yii::t('setupModule.main', 'Start Date'),
			'd_end_date' => Yii::t('setupModule.main', 'End Date'),
			'v_flag_coy_id' => Yii::t('setupModule.main', 'Flag Coy'),
			'v_org_level' => Yii::t('setupModule.main', 'Org Level'),
			'n_org_parent' => Yii::t('setupModule.main','Org Parent'),
			'v_no_account' => Yii::t('setupModule.main', 'No Account'),
			'v_npwp' => Yii::t('setupModule.main', 'Npwp'),
			'v_currency' => Yii::t('setupModule.main', 'Currency'),
			'v_address' => Yii::t('setupModule.main', 'Address'),
			'v_city' => Yii::t('setupModule.main', 'City'),
			'v_province' => Yii::t('setupModule.main', 'Province'),
			'v_country' => Yii::t('setupModule.main', 'Country'),
			'v_post_code' => Yii::t('setupModule.main', 'Post Code'),
			'v_phone' => Yii::t('setupModule.main', 'Phone'),
			'v_contact_person' => Yii::t('setupModule.main', 'Contact Person'),
			'v_phone_person' => Yii::t('setupModule.main', 'Phone Person'),
			'v_email_person' => Yii::t('setupModule.main', 'Email Person'),
			...
			'nOrgParent' => Yii::t('setupModule.main','NOrgParent'),
			'setupMstOrganizations' => Yii::t('setupModule.main','SetupMstOrganizations'),
		);
	}
