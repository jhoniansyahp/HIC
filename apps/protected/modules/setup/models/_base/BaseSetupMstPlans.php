...
abstract class BaseSetupMstPlans extends GxActiveRecord {
	...
	public function attributeLabels() {
		return array(
			...
			'v_plan_name' => Yii::t('app', 'Plan Name'),
			'v_plan_desc' => Yii::t('app', 'Plan Desc'),
			'd_plan_start' => Yii::t('app', 'Plan Start'),
			'd_plan_end' => Yii::t('app', 'Plan End'),
			'v_prod_line' => Yii::t('app', 'Prod Line'),
			'v_prod_composition' => Yii::t('app', 'Prod Composition'),
			'v_indv_or_group' => Yii::t('app', 'Indv Or Group'),
			'v_plan_type' => Yii::t('app', 'Plan Type'),
			'v_curr_code' => Yii::t('app', 'Curr Code'),
			'v_status' => Yii::t('app', 'Status'),
			...
			'polDtlQuots' => Yii::t('app','PolDtlQuots'),
			'setupPlanBenefits' => Yii::t('app','SetupPlanBenefits'),
		);
	}
