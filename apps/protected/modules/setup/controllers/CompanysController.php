...
class CompanysController extends Controller
{
	...
	{
		$model=new SetupMstCoys;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['SetupMstCoys']))
		{
	...
	{
		$model=new SetupMstCoys('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['SetupMstCoys']))
			$model->attributes=$_GET['SetupMstCoys'];
	...
	*/
	...
	{
	        if (isset($_POST['setup-mst-coys-grid_c0']))
	        {
	                $ids = $_POST['setup-mst-coys-grid_c0'];
	...
	{
		$model=SetupMstCoys::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='setup-mst-coys-form')
		{
