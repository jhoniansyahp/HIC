	...
	"value" => "\$org = SetupMstOrganizations::model()->findByPK(\$data->n_org_id); isset(\$org->v_org_name) ? \$org->v_org_name : '-'",
		...
		*/
		array(
			...
			'viewButtonUrl' => 'Yii::app()->createUrl(sprintf("setup/detaillookups/view/id/%s",$data->n_lookup_dtl_id))',
			'updateButtonUrl' => 'Yii::app()->createUrl(sprintf("setup/detaillookups/update/id/%s",$data->n_lookup_dtl_id))',
                    	'deleteButtonUrl' => 'Yii::app()->createUrl(sprintf("setup/detaillookups/delete/id/%s",$data->n_lookup_dtl_id))',
		),
	),
)); 
...
<div class="search-simple-form">
	<?php $this->renderPartial('_primary_search_dtl',array(
		'model'=>$model,
	)); ?>
</div>
<div class="search-advanced-form" style="display:none">
<?php $this->renderPartial('_search_dtl',array(
	'model'=>$model,
)); ?>
</div><!-- search-form -->
