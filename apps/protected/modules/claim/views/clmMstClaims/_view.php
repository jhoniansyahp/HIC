<div class="view">
	...
	<?php echo CHtml::encode($data->d_claim); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('d_submitted')); ?>:</b>
	<?php echo CHtml::encode($data->d_submitted); ?>
	<br />
	...
	<?php echo CHtml::encode($data->d_sent_doc); ?>
	<br />
	...
	<?php echo CHtml::encode($data->d_incident_date); ?>
	<br />
