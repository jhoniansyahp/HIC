...
array(
			'name' => 'vMemberNo',
			'type' => 'raw',
			'value' => $model->vMemberNo !== null ? GxHtml::link(GxHtml::encode(GxHtml::valueEx($model->vMemberNo)), array('polDtlPolis/view', 'id' => GxActiveRecord::extractPkValue($model->vMemberNo, true))) : null,
			),
	),
)); ?>
